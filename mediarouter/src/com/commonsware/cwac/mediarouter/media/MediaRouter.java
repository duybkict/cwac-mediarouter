...
package com.commonsware.cwac.mediarouter.media;
...
import com.commonsware.cwac.mediarouter.media.MediaRouteProvider.ProviderMetadata;
 ...
 * also {@link com.commonsware.cwac.mediarouter.media.MediaRouter.RouteInfo#sendControlRequest send control requests} to the route
...
public final class MediaRouter {
     ...
     * callback is registered, except on {@link android.app.ActivityManager#isLowRamDevice low-RAM devices}.
     * <p>
     ...
     * The android.support.v7.app.MediaRouteDiscoveryFragment fragment may
     * also be used for this purpose.
     * </p><p class="note">
     * On {@link android.app.ActivityManager#isLowRamDevice low-RAM devices} this flag
     * will be ignored.  Refer to
     * {@link #addCallback(MediaRouteSelector, com.commonsware.cwac.mediarouter.media.MediaRouter.Callback, int) addCallback} for details.
     * </p>
     */
    ...
    /**
     * Flag for {@link #addCallback}: Request passive route discovery while this
     * callback is registered, even on {@link android.app.ActivityManager#isLowRamDevice low-RAM devices}.
     * <p class="note">
     ...
     * {@link android.app.ActivityManager#isLowRamDevice low-RAM devices}.
     * </p><p>
     ...
     * {@link com.commonsware.cwac.mediarouter.media.MediaRouter} instance, such as by storing the instance in a field of
     ...
     * </p><p>
     * In other words, the support library only holds a {@link java.lang.ref.WeakReference weak reference}
    ...
    /**
     * Gets information about the {@link com.commonsware.cwac.mediarouter.media.MediaRouter.RouteInfo routes} currently known to
     * this media router.
     */
    ...
    /**
     * Gets information about the {@link com.commonsware.cwac.mediarouter.media.MediaRouter.ProviderInfo route providers}
     ...
     * {@link com.commonsware.cwac.mediarouter.media.MediaRouter.RouteInfo#getControlFilters media control intent filters} to assess the
     ...
     *
     * @see com.commonsware.cwac.mediarouter.media.MediaRouter.RouteInfo#getControlFilters
     * @see com.commonsware.cwac.mediarouter.media.MediaRouter.RouteInfo#supportsControlCategory
     * @see com.commonsware.cwac.mediarouter.media.MediaRouter.RouteInfo#supportsControlRequest
     */
    @NonNull
     ...
     * @see com.commonsware.cwac.mediarouter.media.MediaRouter.RouteInfo#matchesSelector
     * @see com.commonsware.cwac.mediarouter.media.MediaRouter.RouteInfo#isDefault
     */
    @NonNull
     ...
     * </p><p class="note">
     * On {@link android.app.ActivityManager#isLowRamDevice low-RAM devices} this method
     ...
     * {@link #addCallback(MediaRouteSelector, com.commonsware.cwac.mediarouter.media.MediaRouter.Callback, int)} without flags.
     * </p>
     *
     ...
     * On {@link android.app.ActivityManager#isLowRamDevice low-RAM devices} this flag will be
     ...
     * <p>
     * The provider will be added to the list of providers that all {@link com.commonsware.cwac.mediarouter.media.MediaRouter}
     ...
     * <p>
     * The provider will be removed from the list of providers that all {@link com.commonsware.cwac.mediarouter.media.MediaRouter}
     * instances within this process can use to discover routes.
     * </p>
     *
    ...
    public static final class RouteInfo {
         ...
         *
         * @see com.commonsware.cwac.mediarouter.media.MediaRouter#getSelectedRoute
         */
         ...
         *
         * @see com.commonsware.cwac.mediarouter.media.MediaRouter#getDefaultRoute
         */
         ...
         *
         * @param intent A {@link MediaControlIntent media control intent}.
         * @param callback A {@link com.commonsware.cwac.mediarouter.media.MediaRouter.ControlRequestCallback} to invoke with the result
        ...
        /**
         * Gets the {@link android.view.Display} that should be used by the application to show
         ...
         * using the {@link com.commonsware.cwac.mediarouter.media.MediaRouter.Callback#onRoutePresentationDisplayChanged} callback and
    ...
    public static final class ProviderInfo {
        ...
        /**
         * Gets the {@link com.commonsware.cwac.mediarouter.media.MediaRouter.RouteInfo routes} published by this route provider.
         */
        public List<RouteInfo> getRoutes() {
            checkCallingThread();
            return mRoutes;
     ...
     * was registered for unless the {@link com.commonsware.cwac.mediarouter.media.MediaRouter#CALLBACK_FLAG_UNFILTERED_EVENTS}
     * flag was specified in {@link com.commonsware.cwac.mediarouter.media.MediaRouter#addCallback(MediaRouteSelector, com.commonsware.cwac.mediarouter.media.MediaRouter.Callback, int)}.
     * </p>
     *
     * @see com.commonsware.cwac.mediarouter.media.MediaRouter#addCallback(MediaRouteSelector, com.commonsware.cwac.mediarouter.media.MediaRouter.Callback, int)
     * @see com.commonsware.cwac.mediarouter.media.MediaRouter#removeCallback(com.commonsware.cwac.mediarouter.media.MediaRouter.Callback)
     */
    public static abstract class Callback {
         ...
         *
         * @see com.commonsware.cwac.mediarouter.media.MediaRouter.RouteInfo#getPresentationDisplay()
         */
     ...
     *
     * @see com.commonsware.cwac.mediarouter.media.MediaRouter.RouteInfo#sendControlRequest
     */
